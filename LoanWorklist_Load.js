...
var managerallassignedFilter = {
		"queueName": "Inbox",
		"inbasketName": solutionPrefix + "_" + "All Assigned Work",
		"hideFilterUI":false,
		"queryFilter": allInBasketFilter,
		"queryFields": [
		     {
		        "name": "BOC_BranchCode",
		        "type": "xs:string",
...
var model2 = icm.model.InbasketDynamicFilter.fromJSON(managerallassignedFilter);
...
if(filterData.branchCode !=null && filterData.branchCode != undefined && filterData.branchCode.length > 0){
	...
	if(role === "Credit Officer"){
		...
		inbasketName= "Branch Manager";
		queueName = solutionPrefix+"_"+"BranchManager";
	}
